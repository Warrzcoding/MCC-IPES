<?php
// Declare globals for Laravel compatibility
global $CONFIG, $root_path, $root_url, $CONFIG_FILE, $report_errors, $show_hidden_files, $lang_list, $hide_Cols, $calc_folder, $theme, $lang, $sticky_navbar, $favicon_path, $auth_users, $readonly_users, $config_file;
...
$config_file = storage_path('app/tinyfilemanager_config.php');
...
// abs path for site
defined('FM_ROOT_URL') || define('FM_ROOT_URL', url('/'));
defined('FM_SELF_URL') || define('FM_SELF_URL', request()->url());
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        $fm_url = $root_url . (isset($_SERVER["PHP_SELF"]) ? $_SERVER["PHP_SELF"] : '');
        $this->data = array(
            'lang' => 'en',
        ...
        if (isset($CONFIG) && strlen($CONFIG)) {
            ...
            // If global $CONFIG is not set, try to use a default or handle gracefully
            $data = $this->data;
        }
