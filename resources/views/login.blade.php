...
window.adminOtpOverlayEnabled = @json($adminOtpOverlayEnabled);
  ...
  <script src="{{ asset('js/dev-tools-security.js') }}?v=<?php echo time(); ?>"></script>
    ...
    <!-- Floating Manual Icon -->
    <div class="floating-manual-icon" id="floatingManualIcon">
    ...
    <div class="manual-overlay" id="manualOverlay">
        <div class="manual-modal">
            ...
            <p>Welcome to the Instructors Performance Evaluation System (IPES).</p>
            <h3>How to Sign Up</h3>
            <p>1. Tap Start Student Login, go to signup link.</p>
            <p>2. Enter your ms email, Accept terms and Conditions, click continue.</p>
            <p>3. Fill up signup form, then submit</p>
            <p>4. Wait for approval! to signin.<p> 
            <h3>How to Sign In</h3>
            <p>1. Tap Start Student Login.</p>
            <p>2. Enter registered ID. If not Found, not yet approve!</p>
            <p>3. IF verified ID proceed login.</p>
            <p>4. Enter ms email use during presignup.</p>
            <p>5. Enter password.</p>
            <h3>Forgot Password</h3>
            <p>1. Forgot password not available.</p>
            <p>2. Conflict Subject instructors assignment?</p>
            <p>3. For concern and assistance> Please conatact Mccipes Concern fbpage1</p>
        </div>
    </div>
</body>
</html>
