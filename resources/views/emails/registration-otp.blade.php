...
<head>
    ...
    <title>MCC-IPES Registration Eligibility Verification</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        <div class="header">
            ...
            <h1>MCC-IPES Registration</h1>
            <p>Instructors Performance Evaluation System</p>
        </div>

        <div class="content">
            <p>Hello,</p>
            <p>You have requested to verify your Microsoft 365 account to check your registration eligibility for MCC-IPES. Please use the verification code below to complete the verification process.</p>
        </div>
        ...
        <div class="content">
            ...
            <ol>
                <li>Return to the MCC-IPES registration eligibility check page</li>
                <li>Enter this 6-digit code in the verification field</li>
                <li>Click "Verify OTP" to finalize your registration eligibility</li>
            </ol>
        </div>
