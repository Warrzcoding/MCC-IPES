            ...
            categories.forEach(category => {
                ...
                html += `<div class='mb-2'>
                    <div class='d-flex justify-content-between align-items-center'>
                        ...
                        <span class='fw-bold'>${avg.toFixed(2)}/5</span>
                    </div>
                    <div class='range-bar ${colorClass}' style='width:100%;'>
                        <div class='range-bar-fill ${colorClass}' style='width:${(avg/5)*100}%;'></div>
                    </div>
                </div>`;
            });
            html += `</div>`;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (message.toLowerCase().includes('all') && message.toLowerCase().includes('reused')) {
        successText = 'All questions successfully reused!';
    } else if (message.toLowerCase().includes('reused')) {
        successText = 'Question successfully reused!';
    } else {
        successText = message;
    }
