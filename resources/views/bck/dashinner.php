...
<body>
    ...
    <nav class="sidebar" id="sidebar">
        <div class="nav-section">
            ...
            @if(Auth::user()->isAdmin())
                ...
                <a href="{{ route('dashboard', ['page' => 'staff-ratings']) }}" class="nav-link {{ $page === 'staff-ratings' ? 'active' : '' }}">
    ...
    <footer class="footer">
        <div class="footer-content">
            ...
            <div class="footer-links">
                <a href="mailto:developer@example.com" class="developer-link" id="developerBtn">
    ...
    <!-- Developer Floating Images -->
    <div class="developer-float-container" id="developerFloat" style="display:none;">
        <div class="dev-float-item" style="--float-delay:0s;">
            <img src="{{ asset('images/developers/dev1.png') }}" alt="Dev1" class="dev-float-img">
            <div class="dev-float-label">Programmer</div>
        </div>
        <div class="dev-float-item" style="--float-delay:0.2s;">
            <img src="{{ asset('images/developers/dev2.png') }}" alt="Dev2" class="dev-float-img">
            <div class="dev-float-label">UI/UX Designer</div>
        </div>
        <div class="dev-float-item" style="--float-delay:0.4s;">
            <img src="{{ asset('images/developers/dev3.png') }}" alt="Dev3" class="dev-float-img">
            <div class="dev-float-label">Researcher</div>
        </div>
        <div class="dev-float-item" style="--float-delay:0.6s;">
