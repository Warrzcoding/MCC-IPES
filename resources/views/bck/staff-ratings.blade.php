        ...
        fetch(`/staff/detailed-evaluations/${staffId}`)
            ...
            .then(data => {
                if (data.success) {
                    ...
                    let html = `
                        <div style="padding:32px;font-family:sans-serif; max-width: 900px; margin: 0 auto;">
                            <div style='text-align:center;margin-bottom:2em;border-bottom:2px solid #333;padding-bottom:1em;'>
                                <h2 style='margin-bottom:0.2em;'>Staff Evaluation Report</h2>
                                <div style='color:#888;font-size:1.05em;'>Generated on: ${new Date().toLocaleDateString('en-US',{year:'numeric',month:'long',day:'numeric'})}</div>
                            </div>
                            
                            <!-- Instructor Information Line -->
                            <div style='margin-bottom:2em;font-size:1.1em;'>
                                <p style='margin:0.5em 0;'><strong>Name of Instructor:</strong> ${staff.full_name}<strong style='margin-left:3em;'>Department:</strong> ${staff.department}</p>
                            </div>
