    ...
    <style>
        body {
         ...
         .bg-decorations {
            ...
            top: 0;
            left: 0;
            background: url('https://images.unsplash.com/photo-1557683316-973673baf926?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2029&q=80') center/cover no-repeat;
            filter: blur(8px);
            transform: scale(1.1);
            pointer-events: none;
        }
    ...
    <div class="login-card">
        <div class="login-header">
            ...
            @if (!$show_student_form && !$show_login_form)
                ...
                <!-- User Type Selection and Student ID Form -->
                ...
                <form method="POST" id="adminLoginForm" style="display: none;" action="{{ route('login.submit') }}">
                    ...
                    <div id="adminErrorBox" class="alert d-none" style="background: #ff6b6b; color: #fff; border-radius: 18px; box-shadow: 0 2px 12px rgba(255,0,0,0.12); display: flex; align-items: center; justify-content: center; text-align: center; font-weight: 600; padding: 14px 18px; margin-bottom: 18px; letter-spacing: 0.5px;"></div>
                    <div class="mb-3">
            ...
            @if ($show_login_form && $student_data)
                ...
                <div class="student-info">
                    ...
                    <p><strong>Name:</strong> {{ $student_data['full_name'] }}</p>
                    <p><strong>School ID:</strong> {{ $student_data['school_id'] }}</p>
                    <p><strong>Username:</strong> {{ $student_data['username'] }}</p>
                </div>
                ...
                <form method="POST" action="{{ route('login.submit') }}">
                    ...
                    <div id="studentErrorBox" class="alert d-none" style="background: #ff6b6b; color: #fff; border-radius: 18px; box-shadow: 0 2px 12px rgba(255,0,0,0.12); display: flex; align-items: center; justify-content: center; text-align: center; font-weight: 600; padding: 14px 18px; margin-bottom: 18px; letter-spacing: 0.5px;"></div>
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control" id="email" name="email"
                                   placeholder="firstname.lastname@mcclawis.edu.ph" required value="" autocomplete="off"
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-3">
                        <button type="button" class="btn btn-secondary" onclick="resetStudentForm()">
                            <i class="fas fa-arrow-left"></i> Back
                        </button>
...
@endif
    ...
    <script>
        ...
        const studentLoginForm = document.querySelector('form[action*="login.submit"]:not(#adminLoginForm):not(#staffLoginForm)');
        if (studentLoginForm) {
