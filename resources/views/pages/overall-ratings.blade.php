        ...
        <div style="padding: 0.5in 0.5in 0.5in 0.5in; font-family: Arial, sans-serif; font-size:10pt; max-width: 1000px; margin: 0 auto; line-height: 1.15;">
            ...
            <div style="text-align: left; margin-bottom: 0.8em; font-size: 10pt; line-height: 1.2;">
               ...
               <p style="margin-bottom: 1em;">Greetings of Peace!</p>
                ...
                <p style="margin-bottom: 0.7em;">I am writing to formally endorse the Results Summary of Performance Evaluation Results of all MCC ${title} for Academic Year {{ $currentAcademicYear?->year }} - {{ $currentAcademicYear?->semester == 1 ? 'First' : ($currentAcademicYear?->semester == 2 ? 'Second' : $currentAcademicYear?->semester) }} Semester.</p>
