...
<script>
    ...
    function generateAndPrintReport(staffData, department) {
            ...
            <div style="padding: 0.5in 0.5in 0.5in 0.5in; font-family: Arial, sans-serif; font-size:10pt; max-width: 1000px; margin: 0 auto; line-height: 1.15;">
                ...
                <div style="text-align: left; margin-bottom: 0.8em; font-size: 10pt; line-height: 1.2;">
                   ...
                   <p style="margin-bottom: 1em;">Subject:&nbsp;Endorsement of Performance Evaluation Results of ${departmentTitle} Instructors</p>
                    ...
                    <p style="margin-bottom: 0.7em;">I am writing to formally endorse the Results of the Performance Evaluation of ${departmentTitle} instructors for Academic Year {{ $currentAcademicYear?->year }} - {{ $currentAcademicYear?->semester == 1 ? 'First' : ($currentAcademicYear?->semester == 2 ? 'Second' : $currentAcademicYear?->semester) }} Semester.</p>
        ...
        html += `
                ...
                <!-- Signature Section -->
                <div style='margin-top:10em;margin-bottom:0em;text-align:left; font-size:10pt; line-height:1.3;'>
